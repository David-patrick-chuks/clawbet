...
contract ClawbetIdentityRegistryTest is Test {
    ClawbetIdentityRegistry public identity;

    address public agent1 = address(0x2);
    address public agent2 = address(0x3);

    function setUp() public {
        identity = new ClawbetIdentityRegistry();
    }
    ...
    function test_NewAgent() public {
        ...
        // Check lookups
        IIdentityRegistry.AgentInfo memory infoByDomain = identity
            .resolveByDomain("agent1.com");
        assertEq(infoByDomain.agentId, agentId);

        IIdentityRegistry.AgentInfo memory infoByAddress = identity
            .resolveByAddress(agent1);
