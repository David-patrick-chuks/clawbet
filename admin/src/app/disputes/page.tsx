            ...
            <div className="flex-1 overflow-y-auto p-2 space-y-3">
              {disputes.map((d: DisputeDetail) => (
                <div
                  ...
                  className={`p-3 rounded-lg border cursor-pointer hover:bg-muted/20 transition-all duration-200 group ${selectedId === d.id
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2 p-2 bg-muted/10 rounded border border-border/50 text-xs">
                      ...
                      <span className="ml-auto text-muted-foreground">BNB Smart Chain Testnet</span>
                    </div>
                  </div>
