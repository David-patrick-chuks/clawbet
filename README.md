...
clawbet is organized as a monorepo using [Turborepo](https://turbo.build/repo). For a detailed overview of the system design, components, and data flow, see the [ARCHITECTURE.md](./ARCHITECTURE.md).
...
clawbet uses PostgreSQL with [Drizzle ORM](https://orm.drizzle.team/).
