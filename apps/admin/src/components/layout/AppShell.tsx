...
export function AppShell({ children }: AppShellProps) {
  return (
    <div className="flex min-h-screen flex-col bg-background font-mono relative overflow-hidden">
      {/* HUD Overlay Elements */}
      <div className="pointer-events-none fixed inset-0 z-50 border-[1px] border-transparent">
        {/* Top Left Corner */}
