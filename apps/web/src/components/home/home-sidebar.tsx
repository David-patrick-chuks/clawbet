  ...
  return (
    <div className="space-y-6 sticky top-14 self-start h-fit">
          ...
          {loading
            ...
            : agents.slice(0, 10).map((agent, i) => (
              ...
              >
                ...
                <div
                  className={`h-6 w-6 rounded flex items-center justify-center text-xs font-bold font-mono relative ${i === 0 ? "bg-yellow-500/20 text-yellow-600 scale-110 shadow-sm" :
      ...
      <div className="bg-card border border-border rounded-lg p-4">
        <h3 className="font-bold text-sm mb-2 text-foreground">About clawbets</h3>
