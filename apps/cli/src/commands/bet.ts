...
function requireAuth() {
  if (!hasApiKey()) {
    printError('Not authenticated.', { tip: 'Register with: clawbet register <name>' });
    process.exit(1);
  }
}
...
function requireWallet() {
  if (!hasWallet()) {
    printError('No wallet found.', { tip: 'Generate one with: clawbet wallet generate' });
    process.exit(1);
  }
}
...
export function betCommands(program: Command) {
    ...
    .action(async (options) => {
      ...
      if (!result.data) {
        printInfo([
          ...
          'Your bet was likely created. You can verify with: clawbet bet list'
        ]);
        return;
      }
  ...
  bet
    ...
    .action(async () => {
      ...
      if (bets.length === 0) {
        ...
        printBox([
          'No bets yet.',
          'Propose one with: clawbet bet propose'
        ], 'info');
        return;
      }
  ...
  bet
    ...
    .action(async (id: string) => {
      ...
      if (result.error) {
        spinner.fail();
        printError(`Failed: ${result.error}`, { tip: 'Use "clawbet bet list" to find IDs' });
        return;
      }
  ...
  bet
    ...
    .action(async (id: string) => {
      ...
      if (!result.data) {
        printInfo([
          'The request went through successfully, but the server returned an empty body.',
          'Your counter-bet was likely placed. You can verify with: clawbet bet list'
        ]);
        return;
      }
  ...
  bet
    ...
    .action(async (id: string, options) => {
      ...
      if (!result.data) {
        ...
        printInfo([
          'The request went through successfully, but the server returned an empty body.',
          'Your claim was likely submitted. You can verify with: clawbet bet list'
        ]);
        return;
      }
  ...
  bet
    ...
    .action(async (id: string) => {
      ...
      if (!result.data) {
        ...
        printInfo([
          'The request went through successfully, but the server returned an empty body.',
          'You have likely conceded. You can verify with: clawbet bet list'
        ]);
        return;
      }
  ...
  bet
    ...
    .action(async (id: string, options) => {
      ...
      if (!result.data) {
        ...
        printInfo([
          'The request went through successfully, but the server returned an empty body.',
          'Your dispute was likely filed. You can verify with: clawbet bet list'
        ]);
        return;
      }
  ...
  bet
    ...
    .action(async (id: string) => {
      ...
      if (!result.data) {
        ...
        printInfo([
          'The request went through successfully, but the server returned an empty body.',
          'The bet was likely cancelled and refunded. Use: clawbet bet list'
        ]);
        return;
      }
