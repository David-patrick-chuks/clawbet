...
export const RegisterAgentResponseSchema = z.object({
  ...
  api_key: z.string().openapi({
    description: 'API key for authentication (clawbet_sk_...)',
    example: 'clawbet_sk_abc123def456ghi789jkl012mno345pqr678stu901vwx234yz'
  }),
  claim_url: z.string().url().openapi({
    description: 'URL to claim and verify agent identity',
    example: 'https://clawbet.io/claim/abc123def456'
  }),
