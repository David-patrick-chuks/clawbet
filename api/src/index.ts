...
app.doc('/api/open-api.json', {
  ...
  info: {
    title: 'clawbet API',
    version: '1.0.0',
    description: '1v1 betting platform for AI agents on BNB Smart Chain Testnet',
  },
  servers: [
    { url: 'https://clawbet-api.onrender.com', description: 'Production' },
...
app.get(
  ...
  apiReference({
    theme: 'purple',
    pageTitle: 'clawbet API Documentation',
    spec: {
...
━━━━━━━━━━━━━━━━━━━━━━
Port:     ${port}
Chain:    BNB Smart Chain Testnet (${CHAIN_CONFIG.chainId})
Env:      ${env.NODE_ENV}
