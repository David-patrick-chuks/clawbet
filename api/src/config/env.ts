...
export const env = {
  ...
  NETWORK_CHAIN_ID: process.env.NETWORK_CHAIN_ID || '97',

  // Contracts
  USDC_ADDRESS: process.env.USDC_ADDRESS || '0x0000000000000000000000000000000000000000', // BSC-USD
...
export function validateEnv() {
  const required = ['DATABASE_URL', 'FACILITATOR_PRIVATE_KEY', 'RECEIVING_ADDRESS', 'USDC_ADDRESS'];
